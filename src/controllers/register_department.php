                    ...
                    <?php
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            try {
                                ...
                                echo '<div class="alert-message">Department <strong>' . htmlspecialchars($name) . '</strong> successfully registered!</div>';
                                echo '</div>';
                                ...
                                echo '<div class="alert-message">Department <strong>' . htmlspecialchars($name) . '</strong> not registered.</div>';

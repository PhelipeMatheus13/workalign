...
$content = <<<'HTML'
<div class="form-card">
   <h3 class="form-title">Register New Role</h3>
   <form id="roleForm" action="departments/roles/create" method="POST">
      ...
      <div class="form-group">
            ...
            <textarea class="form-control" id="role_description" name="description"
